...
export default function SideBar() {
	...
	// const studentID = localStorage.getItem('studentID').toString();
				...
				<Drawer
					...
					<div className={classes.toolbar}>
						...
						<span>
							<img
								src={logo}
								style={{ height: '30px', width: '30px', paddingRight: '2px' }}
								alt='logo'
							/>{' '}
							<b style={{ fontFamily: "'Montserrat', sans-serif" }}>SRC Page</b>
						</span>
					</div>
					<Divider />
					<List>
						...
						<Link to='/srcPurchase' className={classes.link}>
							<ListItem button>
								<ListItemIcon>
									<HistoryIcon />
								</ListItemIcon>
