...
<AddIcon/> Add a Product
  ...
  <Form.Group controlId="formBasicTitle">
    {/* <Form.Label>Seminar Title</Form.Label> */}
    <Form.Control type="email" name='email' value={this.state.email} onChange={this.changeHandler} placeholder="Email" required />
  </Form.Group>

  <Form.Group controlId="formBasicTitle">
    {/* <Form.Label>Seminar Title</Form.Label> */}
    <Form.Control type="text" name='phone' value={this.state.phone} onChange={this.changeHandler} placeholder="Phone" required />
  </Form.Group>

  <Form.Group controlId="formBasicTitle">
    {/* <Form.Label>Seminar Title</Form.Label> */}
    <Form.Control type="text" name='price' value={this.state.price} onChange={this.changeHandler} placeholder="Price" required />
  </Form.Group>
...
<Form.File id="exampleFormControlFile1" type='file' onChange={this.changeFileHandler} accept="image/*" required/>
  ...
  <Form.Group controlId="exampleForm.SelectCustom">
    ...
    <Form.Control value={this.state.type} name='type' onChange={this.changeHandler} as="select" custom>
